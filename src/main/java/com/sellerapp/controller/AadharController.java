...
public class AadharController {
	 ...
	 * 
	 * @Operation(summary = "upload aadhar card details") public ResponseEntity<?>
	 * uploadAadhar(@RequestBody AadharDTO aadhar)
	 * 
	 * { String frontPagefilename = aadhar.getFrontPage().getOriginalFilename();
	 * String result = aadharService.saveAadharDetails(aadhar); if
	 * ("Success".equals(result)) { return
	 * Response2.generateResponse("Aaadhar card  front details are get upload",
	 * HttpStatus.OK, "200"); }
	 * 
	 * else { return
	 * Response2.generateResponse("Aadhar Card front details are not upload",
	...
	/*
	 * @PostMapping(value = "/verifyAadharCard", consumes =
	 * MediaType.APPLICATION_JSON_VALUE, produces =
	 * MediaType.APPLICATION_JSON_VALUE)
	 * 
	 * @Operation(summary = "verify aadhar card number") public ResponseEntity<?>
	 * verifyAadharcardNumber(@RequestBody AadharDTO aadhar) { boolean isValid =
	 * aadharService.verifyAadharNumber(aadhar); if (isValid) { return
	 * Response2.generateResponse("Aadhar details are verified", HttpStatus.OK,
	 * "200"); } else { return
	 * Response2.generateResponse("Invalid Aadhar card number",
