...
public class PancardController {
   ...
   /*	@PostMapping(value="/uploadPancard",consumes=MediaType.APPLICATION_JSON_VALUE,produces=MediaType.APPLICATION_JSON_VALUE)
	@Operation(summary ="upload pan card details  through pan number")
	public ResponseEntity<?> uploadPancardPhoto(@RequestBody  PancardDTO pan)
	{
	...
	/*@PostMapping(value ="/verifyPancard",consumes=MediaType.APPLICATION_JSON_VALUE,produces=MediaType.APPLICATION_JSON_VALUE)
