...
public class AvailableProductForSellResponse {
	...
	public String toString() {
		return "AvailableProductForSellResponse [productName=" + productName + ", productSubName=" + productSubName
				...
				+ ", distanceFromMandi=" + distanceFromMandi + ", orderOtp=" + orderOtp + ", address=" + address
				+ ", orderCode=" + orderCode + ", harvestDate=" + harvestDate + ", transactionId=" + transactionId
				+ ", imageData=" + imageData + "]";
	}
	public AvailableProductForSellResponse(String productName, String productSubName, String userCode,
			...
			String orderOtp, String address, String orderCode, String harvestDate, String transactionId,
